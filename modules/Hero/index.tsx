...
const Hero = () => {
  ...
  return (
    <div className='hero md:!py-[68px] !py-[50px]'>
      <div className='containers flex flex-col items-center'>
        ...
        <div className='flex items-center gap-[10px] rounded-md !p-1 border border-[#CC9600]'>
          <input type="text" className='bg-transparent text-[#A59F9F] text-[15px] !pl-[36px] md:!max-w-[255px] max-w-[250px] md:h-[50px] h-[30px] outline-0 rounded-md' placeholder={t("hero-input")}/>
